...
BOOKS = {
    "pandas": ("4814400195", "📊", "Pythonによるデータ分析入門 第3版", "Wes McKinney 著",
               "pandas・NumPy・Jupyterを使ったデータ処理の定番書。競馬データ分析の基礎固めに。"),
    "ml":     ("4873117984", "🤖", "Pythonではじめる機械学習", "Andreas C. Müller 著",
               "scikit-learnで学ぶ機械学習の定番書。決定木からアンサンブルまで丁寧に解説。"),
    "stats":  ("4478022216", "📈", "統計学が最強の学問である", "西内 啓 著",
               "データ分析の統計思考をやさしく解説。オッズと確率の関係を直感的に理解できます。"),
    "gamble": ("4867103403", "🏇", "ウルトラ回収率 2024-2025", "伊吹 雅也 著",
               "JRA全競馬場の回収率150%超え条件を実データで解説。期待値の高い買い目選びに直結します。"),
}
